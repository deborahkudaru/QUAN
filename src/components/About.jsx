    ...
    <div className="bg-white dark:bg-[#121212] min-h-screen flex flex-col items-center px-5 lg:px-20 py-10">
      ...
      >
        ...
        >
          ...
          your first impression—and we make sure it speaks volumes. <br /> <br />
          At <span className="text-red-800 font-semibold">Quan Imagery</span>, we go
          beyond photography—we create stories, art, and timeless moments with
          an African touch. Whether you're an individual, artist, entrepreneur,
          model, or brand, our expertise in fashion, beauty, corporate,
          and commercial photography ensures your uniqueness shines. Our photography
      ...
      <motion.div className="flex gap-2 justify-end items-center mt-6 w-full lg:w-auto self-end" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
        ...
        <motion.div animate={{ x: 0 }} whileHover={{ x: 5 }} transition={{ type: "spring", stiffness: 300 }}>
